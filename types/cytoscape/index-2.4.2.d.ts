 ...
 *  - Cy.Singular
 *      The input must be a Singular element.
 *  - Cy.NodeSingular
 *      The inut must be a Singular node.
 *  - Cy.EdgeSingular
 *      The input must be a Singular edge.
 *
 * For a output of a function it will always give:
 *  - Cy.CollectionElements
 *      The output is a collection of node and edge elements OR Singular element.
 *  - Cy.EdgeCollection
 *      The output is a collection of edge elements OR Singular edge.
 *  - Cy.NodeCollection
 *      The output is a collection of node elements OR Singular node.
 * 
...
declare namespace Cy {
     ...
     */
     interface Instance extends CoreGraphManipulation,
       CoreEvents, InstanceViewPort, InstanceAnimation, InstanceLayout, InstanceStyle, InstanceExport {
     ...
     * 'Singular' : a new selection made by the user becomes the entire set of currently 
     *            selected elements (i.e. the previous elements are unselected)
     */
    type SelectionType = "additive" | "Singular";
    ...
    */
    ...
    interface NodeCollection extends Collection, NodeSingular,
        NodeCollectionMetadata, NodeCollectionPosition, NodeCollectionTraversing, NodeCollectionCompound { }
    ...
    interface Singular extends
        SingularManipulation, SingularData, SingularPosition,
    ...
    interface NodeCollectionPosition {
         ...
         */
        positions(callback: (i: number, ele: NodeCollection) => Position): NodeCollection;
        /**
         * Set positions for all nodes based on a Singular position object.
         * 
         * @param pos An object specifying name-value pairs representing dimensions to set.
         */
        positions(pos: Position): NodeCollection;
        ...
        * ele - The element being iterated over for which the function should return a position to set.
        */
        modelPositions(callback: (i: number, ele: NodeCollection) => Position): NodeCollection;
        /**
         * Set positions for all nodes based on a Singular position object.
         * 
         * @param pos An object specifying name-value pairs representing dimensions to set.
         */
        modelPositions(pos: Position): NodeCollection;
        ...
        * ele - The element being iterated over for which the function should return a position to set.
        */
        points(callback: (i: number, ele: NodeCollection) => Position): NodeCollection;
        /**
         * Set positions for all nodes based on a Singular position object.
         * 
         * @param pos An object specifying name-value pairs representing dimensions to set.
         */
        points(pos: Position): NodeCollection;

        /**
        * Allow the user to grab the nodes.
        */
        grabify(): NodeCollection;

        /**
         * Disallow the user to grab the nodes.
         */
        ungrabify(): NodeCollection;
    ...
    interface SearchBreadthFirstOptions {
         ...
         * u - The previous node.
         */
        visit?: (i: number, depth: number, v: NodeCollection, e: EdgeCollection, u: NodeCollection) => boolean;
        /**
    ...
    interface SearchFloydWarshallResult {
       ...
       * Returns the distance from the source node to node.
       */
        distance: (fromNode: NodeSingular | CollectionSelection, toNode: NodeSingular | Selection) => number;

        /**
         * Returns a collection containing the shortest path from the source node to node.
         * The path starts with the source node and includes the edges between the nodes in the path such that if pathTo(node)[i] is an edge, then pathTo(node)[i-1] is the previous node in the path and pathTo(node)[i+1] is the next node in the path.
         */
        path: (fromNode: NodeSingular | CollectionSelection, toNode: NodeSingular | Selection) => Collection;
    }
    ...
    interface SearchBellmanFordResult {
        ...
        */
        pathTo: (node: NodeSingular | Selection) => Collection;

        /**
         *  function that computes the shortest distance from root node to argument node
         * (either objects or selector string) 
         * */
        distanceTo: (node: NodeSingular | Selection) => number;
    ...
    interface SearchPageRankResult {
         ...
         */
        "rank": (node: SingularElement) => number;
    }
    ...
    interface SingularManipulation {
        /**
    ...
    interface NodeSingularPosition {
        ...
        */
         ...
         */
        position(dimension: PositionDimension, value: number): NodeCollection;
        /**
         * Set the position using name-value pairs in the specified object.
         * 
         * @param pos An object specifying name-value pairs representing dimensions to set.
         */
        position(pos: Position): NodeCollection;
         ...
         * @param value The value to set to the dimension.
         */
        modelPosition(dimension: PositionDimension, value: number): NodeCollection;
        /**
         * Set the position using name-value pairs in the specified object.
         * 
         * @param pos An object specifying name-value pairs representing dimensions to set.
         */
        modelPosition(pos: Position): NodeCollection;
         ...
         * @param value The value to set to the dimension.
         */
        point(dimension: PositionDimension, value: number): NodeCollection;
        /**
         * Set the position using name-value pairs in the specified object.
         * 
         * @param pos An object specifying name-value pairs representing dimensions to set.
         */
        point(pos: Position): NodeCollection;
         ...
         * @param value The value to set to the dimension.
         */
        renderedPosition(dimension: PositionDimension, value: number): NodeCollection;
        /**
         * Set the rendered position using name-value pairs in the specified object.
         * 
         * @param pos An object specifying name-value pairs representing dimensions to set.
         */
        renderedPosition(pos: Position): NodeCollection;
         ...
         * @param value The value to set to the dimension.
         */
        renderedPoint(dimension: PositionDimension, value: number): NodeCollection;
        /**
         * Set the rendered position using name-value pairs in the specified object.
         * 
         * @param pos An object specifying name-value pairs representing dimensions to set.
         */
        renderedPoint(pos: Position): NodeCollection;
         ...
         * @param value The value to set to the dimension.
         */
        relativePosition(dimension: PositionDimension, value: number): NodeCollection;
        /**
         * Set the relative position using name-value pairs in the specified object.
         * 
         * @param pos An object specifying name-value pairs representing dimensions to set.
         */
        relativePosition(pos: Position): NodeCollection;
         ...
         * @param value The value to set to the dimension.
         */
        relativePoint(dimension: PositionDimension, value: number): NodeCollection;
        /**
         * Set the relative position using name-value pairs in the specified object.
         * 
         * @param pos An object specifying name-value pairs representing dimensions to set.
         */
        relativePoint(pos: Position): NodeCollection;
    }
    ...
    export namespace Css {
        ...
        */
        ...
        export interface BezierEdges {
            ...
            /** 
             * A Singular value that overrides "control-point-step-size" with a manual value.
            ...
            /** 
             * A Singular value that weights control points along the line from source to target.
    ...
    interface CytoscapeOptions {
        ...
        boxSelectionEnabled?: boolean;
        /**
         * A string indicating the selection behaviour from user input. By default, this is set automatically for you based on the type of input device detected. On touch devices, 'additive' is default — a new selection made by the user adds to the set of currenly selected elements. On mouse-input devices, 'Singular' is default — a new selection made by the user becomes the entire set of currently selected elements (i.e. the previous elements are unselected).
         * 
         * The default value is (isTouchDevice ? 'additive' : 'Singular').
         */
